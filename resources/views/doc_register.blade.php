...
@endif
            ...
            <form action="{{ route('doctor.register.submit') }}" method="POST">
                ...
                <input type="text" name="worplc" placeholder="Currently Working" required>
                <input type="text" name="nid" placeholder="NID Number" required>
                <input type="text" name="degree" placeholder="Degree" required>
                <input type="text" name="institution" placeholder="Medical College" required>
                <input type="text" name="bmdc" placeholder="BMCD Registration Number" required>
